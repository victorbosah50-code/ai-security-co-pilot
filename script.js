...
analyzeBtn.addEventListener("click", async () => {
  ...
  try {
    // Trigger the workflow via GitHub Actions
    await fetch("/.netlify/functions/trigger-ai", {  // Or your GitHub Action proxy endpoint
      method: "POST",
    ...
    // Risk meter (optional local simulation)
    let risk = 0;
